...
(*
    ("-s",
      Arg.Unit (fun () -> Sq.sw_simp := true),
      " Apply replacement rules. Version 1.1 and earlier only.");
    ("-s2",
      Arg.Unit (fun () -> Sq.sw_simpExt := true),
      " Apply permanence rules. Version 1.1 and earlier only.")
*)
    ] in
